...
c            double complex elements long, where n2 is the greatest integer
...
c               max( (krank+1)*(3*m+5*n+11)+8*krank^2, (2*n+1)*(n2+1) )
c               double complex elements long, where n2 is
...
c
     ...
     1          iwork,lwork,k,ier,lw2,iu,iv,is,iui,ivi,isi,lu,lv,ls
        ...
        double complex a(m,n),winit(17*m+70),w(*)
c
c
...
c
        ...
        double complex a(m,n),u(m,krank),v(n,krank),
