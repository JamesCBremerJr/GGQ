...
c
c       work:
c       u -- must be at least m double precision elements long
c
c       reference:
...
c
        ...
        double precision snorm,enorm,p1t,p2t,p3t,p4t,p1,p2,p3,p4
        double precision v(n), u(m)
...
c
c       work:
c       w -- must be at least 3*m+3*n double precision elements long
c
c       reference:
c       Kuczynski and Wozniakowski, "Estimating the largest eigenvalue
c            by the power and Lanczos algorithms with a random start,"
...
c
     ...
     1          iv,lv,iv1,lv1,iv2,lv2
        double precision :: snorm,p1t,p2t,p3t,p4t,p1t2,p2t2,p3t2,p4t2,
...
c
        implicit none
        integer m,n,its,it,k
        double precision :: snorm,enorm,p1t,p2t,p3t,p4t,p1t2,p2t2,p3t2,
     1         p4t2,p1,p2,p3,p4,p12,p22,p32,p42,u(m),u1(m),u2(m),
     2         v(n),v1(n),v2(n)
        external matvect,matvec,matvect2,matvec2
c
c
