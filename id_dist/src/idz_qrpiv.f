...
c
        ...
        double precision work(krank)
        double complex a(m,n),b(m,l)
c
c
        if(ifadjoint .eq. 0) then
c
...
c
        ...
        double precision ss(n),eps,ssmax,scal,ssmaxin,rswap,feps
        double complex a(m,n),cswap
c
c
        feps = .1d-16
c
...
c
        ...
        integer n,m,ind(n),krank,k,j,kpiv,mm,nupdate,ifrescal,
     1          loops,loop
        double precision ss(n),ssmax,scal,ssmaxin,rswap,feps
        double complex a(m,n),cswap
c
c
        feps = .1d-16
