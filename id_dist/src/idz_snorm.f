...
c
c       work:
c       u -- must be at least m double complex elements long
c
c       reference:
...
c
        ...
        double precision snorm,enorm
        double complex p1a,p2a,p3a,p4a,p1,p2,p3,p4,u(m),v(n)
...
c
c       work:
c       w -- must be at least 3*m+3*n double complex elements long
c
c       reference:
c       Kuczynski and Wozniakowski, "Estimating the largest eigenvalue
c            by the power and Lanczos algorithms with a random start,"
...
c
     ...
     1          iv,lv,iv1,lv1,iv2,lv2
        ...
        double complex p1a,p2a,p3a,p4a,p1a2,p2a2,p3a2,p4a2,
