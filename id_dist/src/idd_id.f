...
c
        ...
        double precision a(m,n),eps,rnorms(n)
c
c
c       QR decompose a.
c
...
c
        ...
        double precision a(m,n),rnorms(n),ss
c
c
c       QR decompose a.
c
...
c
        ...
        double precision col(m,krank),proj(krank,n-krank),approx(m,n)
c
c
        do j = 1,m
          do k = 1,n
...
c
c       work:
c       x -- must be at least n double precision elements long
c
        implicit none
        integer m,n,krank,list(krank),j,k
        double precision col(m,krank),x(n),p1,p2,p3,p4
        external matvec
c
c
        do j = 1,krank
...
c
        ...
        double precision proj(krank,n-krank),p(krank,n)
c
c
        do k = 1,krank
          do j = 1,n
...
c
        implicit none
        integer m,n,krank,list(krank),j,k
        double precision a(m,n),col(m,krank)
c
c
        do k = 1,krank
          do j = 1,m
