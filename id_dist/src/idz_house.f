...
c
        ...
        double precision scal,sum
        double complex vn(2:*),u(n),v(n),fact
c
c
...
c
        ...
        save
        integer n,k
        double precision scal,test,rss,sum
        double complex x(n),v1,vn(2:*),x1,phase,css
c
c
        x1 = x(1)
c
...
c
        ...
        double complex vn(2:*),h(n,n),factor1,factor2
c
c
