...
c
        implicit none
        integer l,ind(l),n
        double complex wsave(2*l+15+4*n)
c
c
...
c
        implicit none
        integer ind,n,k
        double precision r1,twopi,wsave(2*(2+15+4*n)),fact
c
        r1 = 1
        twopi = 2*4*atan(r1)
c
...
c
        ...
        double precision r1,twopi,fact
        double complex wsave(2*l+15+4*n),ci,twopii
c
        ci = (0,1)
        r1 = 1
        twopi = 2*4*atan(r1)
...
c
        implicit none
        integer ind,n,k
        double precision v(n),r1,twopi,sumr,sumi,fact
        double precision wsave(2*(2+15+4*n))
c
        r1 = 1
        twopi = 2*4*atan(r1)
c
...
c
        ...
        double precision r1,twopi,v(n),rsum,fact
        double complex wsave(2*l+15+4*n),ci,sum
c
        ci = (0,1)
        r1 = 1
        twopi = 2*4*atan(r1)
