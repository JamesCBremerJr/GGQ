...
c            double complex elements long
c
...
c
     ...
     1          info,j,ier,io
        ...
        double complex a(m,n),u(m,krank),v(n*krank),r(*)
c
c
        io = 8*min(m,n)
c
...
c
c       input:
c       lw -- maximum usable length of w (in double complex elements)
...
c
        ...
        double complex a(m,n),r(krank,n)
c
c
