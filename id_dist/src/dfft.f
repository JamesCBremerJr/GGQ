...
C 
C sinQB IS THE UNNORMALIZED INVERSE OF sinQF SINCE A CALL OF DSINQF
...
C 
C sinQF IS THE UNNORMALIZED INVERSE OF sinQB SINCE A CALL OF DSINQB
...
C IS DEFINED BELOW AT OUTPUT PARAMETER X
C 
C cosQF IS THE UNNORMALIZED INVERSE OF cosQB SINCE A CALL OF DCOSQF
...
C THE TRANSFORM IS DEFINED BELOW AT OUTPUT PARAMETER X.
C 
C cosQB IS THE UNNORMALIZED INVERSE OF cosQF SINCE A CALL OF DCOSQB
