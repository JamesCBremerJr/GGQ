...
c               proj must be at least m+(krank+3)*n double precision elements
c               long
c
...
c
        ...
        double precision p1,p2,p3,p4,proj(m+(krank+3)*n)
        external matvect
c
c
...
c
        ...
        double precision x(m),y(n),p1,p2,p3,p4,r(krank+2,n)
        external matvect
c
c
