...
c
        ...
        double precision a(m,n),q(m,m),scal
c
c
...
c
        ...
        double precision a(m,n),v(m),scal
c
c
        ifrescal = 1
c
...
c
c       work:
c       work -- must be at least krank double precision elements long
c
        implicit none
        integer l,m,n,krank,j,k,ifrescal,mm,iftranspose
        double precision a(m,n),b(m,l),work(krank)
c
c
        if(iftranspose .eq. 0) then
c
...
c
c       work:
c       ss -- must be at least n double precision words long
c
...
c
        ...
        double precision a(m,n),ss(n),eps,feps,ssmax,scal,ssmaxin,rswap
c
c
        feps = .1d-16
c
...
c
        ...
        integer n,m,ind(n),krank,k,j,kpiv,mm,nupdate,ifrescal,
     1          loops,loop
        double precision a(m,n),ss(n),ssmax,scal,ssmaxin,rswap,feps
c
c
        feps = .1d-16
c
