...
c
c       input:
c       lw -- maximum usable length (in double precision elements)
c             of the array w
...
c            (krank+1)*(3*m+5*n+1)+25*krank**2 double precision elements long,
...
c               double precision elements long, where krank is the rank
...
c
     ...
     1          iwork,lwork,ier,lproj,iu,iv,is,lu,lv,ls,iui,ivi,isi,k
        double precision eps,p1t,p2t,p3t,p4t,p1,p2,p3,p4,w(*)
...
c
        ...
        double precision p1t,p2t,p3t,p4t,p1,p2,p3,p4,u(m,krank),
     1         v(n,krank),s(krank),proj(krank,n-krank),col(m*krank),
